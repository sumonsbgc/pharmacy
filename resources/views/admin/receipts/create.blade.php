            ...
            <div class="row justify-content-center">
                <div class="col-7">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.receipt.store') }}" class="" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" name="receipt_title" class="form-control @error('receipt_title') is-invalid @enderror" id="receipt_title" placeholder="e.g: Outstanding Sales" value="{{ old('receipt_title') }}" required>
                                        @error('receipt_title')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-12">
                                        ...
                                        <input type="number" name="amount" class="form-control @error('amount') is-invalid @enderror" id="amount" placeholder="e.g: 10000" value="{{ old('amount') }}">
                                        @error('amount')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
